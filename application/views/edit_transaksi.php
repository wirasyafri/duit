...
<!-- 
            ...
            <div class="form-group">
                <label>NOMINAL</label>
                <input type="text" name="nominal" value="<?php echo $transaksi->nominal ?>" class="form-control tanpa-rupiah">
              </div>
            <div class="form-group">
                <label>GET</label>
                <input type="text" name="bayar" value="<?php echo $transaksi->bayar ?>" class="form-control tanpa-rupiah">
            </div>
              <div class="form-group">
                <label>TANGGAL</label>
